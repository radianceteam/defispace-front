                ...
                <MainBlock
                    ...
                    content={
                        <div>
                            ...
                            />
                            <svg className="add-liquidity-plus" width="45" height="46" viewBox="0 0 45 46" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        mixPercentValue(fromValue, ratesData.totalSupply) !== 0 ?
                            ...
                            {walletIsConnected ?
                                <button onClick={() => handleConfirm()}
                                        className={(fromToken.symbol && toToken.symbol && fromValue && toValue) ? "btn mainblock-btn" : "btn mainblock-btn btn--disabled"}>Supply</button> :
