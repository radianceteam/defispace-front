...
function Account() {
    ...
    const acceptedPairTokens = useSelector(state => state.walletReducer.acceptedPairTokens);
            ...
            {!clientData.status ?
                <ExtensionsList/>
                    ...
                    <MainBlock
                        ...
                        normalTitle={true}
                        title={<>
                            <svg className="logo" width="39" height="35" viewBox="0 0 39 35" fill="none"
                            ...
                            <span className="account-title">{curExt._extLib && curExt._extLib.name} Extension</span>
                        </>
                        }
                        button={
                            <svg onClick={() => history.goBack()} className="close" width="26" height="26"
                        ...
                        content={
                            <div className="account-body">
                                ...
                                <div className="account-wrapper">
                                    ...
                                    <a href={`https://net.ton.live/accounts/accountDetails?id=${clientData.address}`} target="_blank"
                                       className="account-link">Ton.live</a>
                                    <button className="account-btn account-disconnect"
                                            onClick={() => disconnectHandler()}>Disconnect
                                    </button>
                                </div>
                            </div>
                        }
                            ...
                            // transactionsList.length ? (
                                <div className="mainblock-footer account-footer">
                                    ...
                                    <ul className="account-footer-list">
                                        ...
                                        {transactionsList.map((i, index) => i.type === "swap" && (
                                            <li className="account-footer-list-item" key={index}>
                                                {i.toValue === null &&
                                                <span>Swapping {i.fromValue.toFixed(4)} {i.fromSymbol} to {i.toSymbol}</span>}
                                                {i.toValue !== null &&
                                                <span>Swap {i.fromValue.toFixed(4)} {i.fromSymbol} to {i.toValue.toFixed(4)} {i.toSymbol}</span>}
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M5.73312 0H14.3057C17.4574 0 19.9998 2.54737 19.9998 5.70526V14.2947C19.9998 17.4526 17.4364 20 14.3057 20H5.73312C2.58143 20 0.0390625 17.4316 0.0390625 14.2947V5.70526C0.0390625 2.54737 2.58143 0 5.73312 0Z"
                                        ...
                                        {transactionsList.map((i, index) => i.type === "processLiquidity" && (
                                            <li className="account-footer-list-item" key={index}>
                                                <span>Process liquidity: {i.fromValue.toFixed(4)} {i.fromSymbol} and {i.toValue.toFixed(4)} {i.toSymbol} for {i.lpTokens} {i.LPsymbol}</span>
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M5.73312 0H14.3057C17.4574 0 19.9998 2.54737 19.9998 5.70526V14.2947C19.9998 17.4526 17.4364 20 14.3057 20H5.73312C2.58143 20 0.0390625 17.4316 0.0390625 14.2947V5.70526C0.0390625 2.54737 2.58143 0 5.73312 0Z"
                                        ...
                                        {acceptedPairTokens.length && acceptedPairTokens.map((i, index) => i.name === "acceptedPairTokens" && (
                                            <li className="account-footer-list-item" key={index}>
                                                <span>Your are provide liquidity and get: {i.amount} {i.token_symbol}</span>
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M5.73312 0H14.3057C17.4574 0 19.9998 2.54737 19.9998 5.70526V14.2947C19.9998 17.4526 17.4364 20 14.3057 20H5.73312C2.58143 20 0.0390625 17.4316 0.0390625 14.2947V5.70526C0.0390625 2.54737 2.58143 0 5.73312 0Z"
