  ...
  return (
    <>
      ...
      <Switch location={location}>
        ...
        <Route path="/sendAssets" component={Assets} />
        <Route path="/send-assets" component={SendAssets} />
        <Route path="/receive" component={ReceiveAssets} />
          <Route path="/receiveAssets" component={AssetsModalReceive} />
          <Route path="/sendTokens" component={AssetsModal} />
