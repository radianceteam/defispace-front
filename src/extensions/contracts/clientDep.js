...
const { DEXClientContract } = require("../ton-packages/DEXClient.js");
const { DEXRootContract } = require("../ton-packages/DEXRoot.js");
const { DEXRootCode } = require("../ton-packages/DEXRootCode.js");
const { GiverContract } = require("../ton-packages/Giver.js");
const fs = require('fs');
const pathJson = '../keys/DEXClientContract.json';
...
async function main(client) {
    let response;
    const rootAddress = "0:ea01eb111ca5f76586d1d9c118cad84eedbda54fcc9a52e3bced8223885015a6"
