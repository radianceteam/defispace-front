...
import {
    ...
    hideEnterSeedPhrase, setNewSide,
...
function EnterSeedPhrase(props) {
  ...
  wordTwelve: "",
    ...
    function handleClose() {
        return dispatch(hideEnterSeedPhrase())
    }
                ...
                content={
                     <>
                         {enterSeedPhraseSide === "login" && <>
                            <Grid container spacing={3} sx={{justifyContent: "center"}}>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordOneError} label="Word 1" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordTwoError} label="Word 2" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordThreeError}  label="Word 3" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordFourError} label="Word 4" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordFiveError} label="Word 5" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordSixError} label="Word 6" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordSevenError} label="Word 7" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordEightError} label="Word 8" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordNineError} label="Word 9" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordTenError} label="Word 10" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordElevenError} label="Word 11" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} error={wordTwelveError} label="Word 12" />}
                                    />
                                </Grid>
                            </Grid>
                            ...
                            <Box sx={{display: "flex", justifyContent: "center", marginTop: "24px"}}>
                                ...
                                <Alert severity="info">
                                    ...
                                    You can paste seed phrase into page (Ctrl + V), and the fields will be automatically filled
                                </Alert>
                            </Box>
                            ...
                            <Box sx={{display: "flex", justifyContent: "center", marginTop: "24px"}}>
                                ...
                                <Alert severity="warning">
                                    ...
                                    The encrypted string with the seed phrase is stored in your computer's browser storage.
                                    DefiSpace service <strong>cannot decrypt</strong> it without knowing the password.
                                </Alert>
                            </Box>

                            <Box sx={{display: "flex", justifyContent: "center", marginTop: "24px"}}>
                                <button style={{fontSize: "24px"}} onClick={login} className="btn wallet-btn">Log in</button>
                            </Box>
                        </>}
                         {enterSeedPhraseSide === "register" && <>
                             ...
                             <Box sx={{display: "flex", justifyContent: "center", marginTop: "24px"}}>
                                 ...
                                 <Alert severity={"warning"} sx={{width: "100%"}}>
                                     ...
                                     It is very important to keep the seed phrase. It cannot be restored. The DefiSpace service does not store the seed phrase, and will not be able to help if it is lost. Remember this.
                                 </Alert>
                             </Box>

                             <Box sx={{display: "flex", justifyContent: "center", marginTop: "24px"}}>
                                 <Grid container sx={{justifyContent: "space-between"}} spacing={2}>
                                     <Grid item><button style={{fontSize: "16px"}} onClick={genPhrase} className="btn wallet-btn">Re-create seed phrase</button></Grid>
                                     <Grid item><button style={{fontSize: "16px"}} onClick={continueReg} className="btn wallet-btn">Continue</button></Grid>
                                     <Grid item><button style={{fontSize: "16px"}} onClick={copySeedPhrase} className="btn wallet-btn">Copy</button></Grid>
                                 </Grid>
                             </Box>
                         </>}
                         {enterSeedPhraseSide === "confirmReg" && <>
                             ...
                             {errorAfterCheck === null && <Box sx={{display: "flex", justifyContent: "center", marginTop: "24px"}}>

                                 <Alert severity="info" sx={{width: "100%"}}>
                                     <AlertTitle>Check doesn't started</AlertTitle>
                                     When you enter twelve words of the seed phrase, we will automatically run a check. If you doesn't save Seed Phrase, you can back.
                                 </Alert>
                             </Box>
                             }
                             {errorAfterCheck === false && <Box sx={{display: "flex", justifyContent: "center", marginTop: "24px"}}>
                             ...
                             {errorAfterCheck === true && <Box sx={{display: "flex", justifyContent: "center", marginTop: "24px"}}>

                                 <Alert severity="error" sx={{width: "100%"}}>
                                     <AlertTitle>Check failed</AlertTitle>
                                     After checking, we came to the conclusion that you entered an incorrect seed phrase. Please go back to the previous step and save <strong>the new seed phrase</strong>.
                                 </Alert>
                                 </Box>
                             }
                             {(errorAfterCheck === true || errorAfterCheck === null) && <Box sx={{display: "flex", justifyContent: "center", marginTop: "24px"}}>
                                 <button style={{fontSize: "24px"}} onClick={backToGen} className="btn wallet-btn">Back</button>
                             </Box>}
                             {errorAfterCheck === false && <Box sx={{display: "flex", justifyContent: "center", marginTop: "24px"}}>
                                 <button style={{fontSize: "24px"}} onClick={validateSP} className="btn wallet-btn">Create wallet</button>
                             </Box>}
                         </>}
                        </>
                }
