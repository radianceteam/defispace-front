    ...
    return (
        <div className="popup-wrapper">
            <MainBlock
                ...
                button={
                    <svg onClick={() => history.push("/pool")} className="close" width="26" height="26"
                ...
                content={
                    <>
                        ...
                        <button onClick={handleSupplyClick} to={'/add-liquidity'} className="btn popup-btn">Supply
                        </button>
                        {balance !== 0 ?
                            <div className="manage-remove-link"><span onClick={() => props.func()}>Remove</span>
                            </div> : null}
                    </>
                }
                footer={
