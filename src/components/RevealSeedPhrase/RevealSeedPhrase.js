...
function RevealSeedPhrase(props) {
  ...
  wordTwelve: "",
    ...
    function handleClose() {
        return dispatch(hideRevealSeedPhrase())
    }

    const [loadSeedPhrase, setLoadSeedPhrase] = useState(true);
    ...
    async function parseSeedPhrase(seedPhrase) {
        ...
        setWordNine(arr[8])
        setWordTen(arr[9])
        setWordEleven(arr[10])
        setWordTwelve(arr[11])
        setLoadSeedPhrase(false);
    }

    const seedPhrase = useSelector(state => state.enterSeedPhrase.revealSeedPhraseText)

    useEffect(async () => {
        await parseSeedPhrase(seedPhrase)
    }, [seedPhrase])
                            ...
                            <Grid container spacing={3} sx={{justifyContent: "center"}}>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 1" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 2" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 3" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 4" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 5" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 6" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 7" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 8" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 9" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 10" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 11" />}
                                    />
                                </Grid>
                                <Grid item>
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => option}
                                        sx={{ width: 160 }}
                                        renderInput={(params) => <TextField {...params} label="Word 12" />}
                                    />
                                </Grid>
                            </Grid>
