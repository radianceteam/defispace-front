            ...
            <div className="extensions-list">
              <div className="extensions-list-item"  onClick={() => handleClick("mnemonic")}>
                <div style={{
                  ...
                  <button style={{fontSize: "16px", width: "fit-content", marginBottom: "40px"}} className="btn wallet-btn" onClick={() => dispatch(showEnterSeedPhrase())}>Login using Seed Phrase</button>
                  <button style={{fontSize: "16px", width: "fit-content"}} className="btn wallet-btn" onClick={() => dispatch(showEnterSeedPhraseRegister())}>Create a new Seed Phrase and Wallet</button>
