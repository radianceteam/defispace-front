...
import {showEnterSeedPhrase, showEnterSeedPhraseRegister} from "../../store/actions/enterSeedPhrase";
...
function ExtensionsList() {
    ...
    return (
        ...
        <MainBlock
            ...
            button={
                <svg onClick={() => history.goBack()} className="close" width="26" height="26" viewBox="0 0 26 26"
                    ...
                    <div className="extensions-list">
                        <div className="extensions-list-item" onClick={() => handleClick("mnemonic")}>
                            <div style={{
                                ...
                                <button style={{fontSize: "16px", width: "fit-content", marginBottom: "40px"}}
                                        className="btn wallet-btn"
                                        onClick={() => dispatch(showEnterSeedPhrase(true))}>Login using Seed Phrase
                                </button>
                                <button style={{fontSize: "16px", width: "fit-content"}} className="btn wallet-btn"
                                        onClick={() => dispatch(showEnterSeedPhraseRegister())}>Create a new Seed Phrase
                                    and Wallet
                                </button>
