            ...
            <div className="extensions-list">
              <div className="extensions-list-item"  onClick={() => handleClick("mnemonic")}>
                <div style={{
                  ...
                  <button style={{fontSize: "16px", width: "fit-content", marginBottom: "40px"}} className="btn wallet-btn" onClick={() => dispatch(showEnterSeedPhrase(true))}>Login using Seed Phrase</button>
