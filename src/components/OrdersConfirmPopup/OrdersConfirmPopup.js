...
import { hideOrdersConfirmPopup, setOrdersAsyncIsWaiting } from '../../store/actions/limitOrders';
...
function OrdersConfirmPopup(props) {
    ...
    return (
        <div className="popup-wrapper">
            <MainBlock
                button={
                    <svg onClick={() => dispatch(props.hideConfirmPopup())} className="close" width="26" height="26"
                    ...
                    <>
                        <div className="confirm-block swap-confirm-block">
                            <span className="confirm-token"><img className="confirm-icon"
                                ...
                                alt={fromToken.symbol} />{fromValue}</span>
                            {appTheme === 'light' ?
                    ...
                    <div className="mainblock-footer">
                        <div className="mainblock-footer-wrap">
                            ...
                            <div className="swap-confirm-wrap">
                                <p className="mainblock-footer-value"><img src={miniSwap}
                                    alt="" /> {rate < 0.0001 ? parseFloat(rate.toFixed(8)) : parseFloat(rate.toFixed(4))} {toToken.symbol}/{fromToken.symbol}
                                </p>
...
export default OrdersConfirmPopup;
