                ...
                content={
                    !walletIsConnected ?
                        ...
                        !tokenList.length && !LPTokenList.length ?
                            <div><p className="wallet-ballance" style={{"margin": "0", "marginBottom": "10px"}}>You
                                don't have any wallets for your assets.</p>
                                <p className="wallet-ballance" style={{"margin": "0", "marginBottom": "10px"}}>Please go
                                    to "Swap", choose a pair of assets and "Connect pair", then come back — we'll create
                                    some wallets for you here.</p></div> :
                            (<>
