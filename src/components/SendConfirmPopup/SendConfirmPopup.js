            ...
            <MainBlock
                ...
                content={
                    <>
                        ...
                        <div className="confirm-block swap-confirm-block" style={{"display":"flex","flexDirection":"column"}}>

                            <div className="confirm_recip_data">
                                <span className="confirm-token"><img className="confirm-icon"
                        ...
                        <p className="confirm-text">
                            ...
                            assets {/*Output is estimated. You will receive at least <span>{toValue < 0.0001 ? parseFloat(getAmountOut(fromValue).toFixed(8)) : parseFloat(getAmountOut(fromValue).toFixed(4))} {fromToken.symbol}</span> or the transaction will revert*/}
                        </p>
                        <button className="btn popup-btn" onClick={() => props.handleSend()}>Confirm Send</button>
                    </>
                }
                footer={
...
export default SendConfirmPopup;
